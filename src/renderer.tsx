...
const BACKEND_URL: string = (import.meta as any).env?.VITE_BACKEND_URL ?? 'https://api.hscho-portfolio.site'
...
const FA_CSS = 'https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@7.2.0/css/all.min.css'
const FONTS_CSS =
